-- Create Database
CREATE DATABASE IF NOT EXISTS mitsubishi_bis CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE mitsubishi_bis;
...
CREATE TABLE employee_addresses (
    ...
    address_type ENUM('Current', 'Permanent', 'Emergency') NOT NULL,
...
-- Employee History Table (Position Changes, Transfers, Promotions)
CREATE TABLE employee_history (
    history_id INT PRIMARY KEY AUTO_INCREMENT,
    employee_id INT NOT NULL,
    change_type ENUM('Promotion', 'Transfer', 'Salary_Adjustment', 'Contract_Renewal', 'Termination') NOT NULL,
...
-- Employee Tax Information Table
CREATE TABLE employee_tax_info (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (employee_id) REFERENCES employees(employee_id) ON DELETE CASCADE,
    UNIQUE KEY unique_employee_year (employee_id, tax_year)
);
...
('MFG', 'Manufacturing', 'Manufacturing Department');

INSERT INTO positions (position_code, position_name, level) VALUES
('MGR', 'Manager', 5),
('SMGR', 'Senior Manager', 6),
('SPV', 'Supervisor', 4),
('SR', 'Senior Staff', 3),
('JR', 'Junior Staff', 2),
('INT', 'Intern', 1);

INSERT INTO employees (employee_code, title, first_name, last_name, first_name_en, last_name_en, national_id, birth_date, gender, email, phone, department_id, position_id, hire_date, salary, employment_status) VALUES
